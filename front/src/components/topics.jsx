export const TOPICS = [
  { name: "Propósito", icon: "/icons/12_objetivo.svg" },
  { name: "Autonomía", icon: "/icons/12_amable.svg" },
  { name: "Maestría", icon: "/icons/12_aprendizaje.svg" },
  { name: "Social", icon: "/icons/12_social.svg" },
  { name: "Descanso", icon: "/icons/12_descanso.svg" },
